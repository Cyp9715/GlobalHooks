...
The original creator is Indieteur [Indieteur](https://github.com/Indieteur), and the code is as mentioned above.
[CC0 1.0 Universal (CC0 1.0)-Public Domain Dedication](https://creativecommons.org/publicdomain/zero/1.0/) Follow.
